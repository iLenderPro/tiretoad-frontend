...
function VendorResponseChatAgent(props: VendorResponseChatProps) {
  ...
  return vendorResponse && session.user ? (
    <Stack gap={2}>
      ...
      <Stack direction="row" width={1} justifyContent="space-between" alignItems="center"></Stack>
...
export default memo(VendorResponseChatAgent);
